                            ...
                            <div class="gallery-zone">
                                ...
                                <ul>
	                               	<c:forEach var="item" items="${boardList }" varStatus="status">
	                                    <li> 
	                                        <a href="site/video_view.do?searchText=${boardVo.searchText}&currentPageNo=${paginationInfo.currentPageNo }&boardSeq=${item.boardSeq }"><img src="${item.serviceFilePath }" width="234" height="176" alt=""></a>
