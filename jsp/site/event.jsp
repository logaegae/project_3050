        ...
        <div class="sub-main-wrap">
            <div class="sub-lnb">
                <ul class="sub-lnb-area">
                    ...
                    <li><a href="site/event.do"><img src="public/tzfz/images/sub/common/event.png" alt="이벤트 소식"></a></li>
                </ul>
            </div>
            <div class="sub-table-cell-wrap">
                <div class="sub-lnb-left">
                    <ul>
                        ...
                        <ul class="lnb-dep2-list">
                            <li class="lnb-dep2 on"><a href="site/event.do"><span>이벤트 소식</span></a></li>
                ...
                <div class="sub-contents">
                    <div class="sub-top-content">
                        <h2 class="content-title">이벤트 소식</h2>
                    </div>
                                    ...
                                    <tbody>
                                    	...
                                    	<c:forEach var="item" items="${boardList }" varStatus="status">
	                                        <tr>
	                                            ...
	                                            <td><a href="site/event_view.do?searchText=${boardVo.searchText}&currentPageNo=${paginationInfo.currentPageNo }&boardSeq=${item.boardSeq }">${item.title }</a></td>
