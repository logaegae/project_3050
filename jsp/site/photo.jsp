        ...
        <div class="sub-main-wrap">
            <div class="sub-lnb">
                <ul class="sub-lnb-area">
                    ...
                    <li><a href="site/photo.do"><img src="public/tzfz/images/sub/common/photo.png" alt="사진 역사관"></a></li>
                </ul>
            </div>
            <div class="sub-table-cell-wrap">
                <div class="sub-lnb-left">
                    <ul>
                        ...
                        <ul class="lnb-dep2-list">
                            ...
                            <li class="lnb-dep2 on"><a href="site/photo.do"><span>사진 역사관</span></a></li>
                ...
                <div class="sub-lnb-center">
                    <img src="public/tzfz/images/sub/common/m_lnb_photo.png" alt="" class="img-responsive center-block">
                </div>
                <div class="sub-contents">
                    <div class="sub-top-content">
                        <h2 class="content-title">사진 역사관</h2>
                    </div>
                            ...
                            <div class="gallery-zone">
                                ...
                                <ul>
	                               	<c:forEach var="item" items="${boardList }" varStatus="status">
	                                    <li> 
	                                        <a href="site/photo_view.do?searchText=${boardVo.searchText}&currentPageNo=${paginationInfo.currentPageNo }&boardSeq=${item.boardSeq }"><img src="${item.serviceFilePath }" width="234" height="176" alt=""></a>
