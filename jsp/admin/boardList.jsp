			...
			<div class="well">
				<form name="frm" id="frm" method="get">
					<div class="input-group">
						<input type="text" id="searchText" name="searchText" class="form-control" placeholder="Search..." value="${boardVo.searchText }">
	...
	<div class="row">
		<div class="col-lg-12">
								...
								<c:forEach var="item" items="${boardList }" varStatus="status">
									<tr>
										...
										<td class="text-left"><a
											href="form.do?searchText=${boardVo.searchText}&currentPageNo=${paginationInfo.currentPageNo }&boardSeq=${item.boardSeq }">${item.title }</a></td>
										<td class="text-center">${item.registUser }</td>
			...
			<div class="text-right">
				<p>
					<a href="form.do" class="btn btn-success">등록</a>
				</p>
			</div>
		</div>
	</div>
